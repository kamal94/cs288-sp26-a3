"""
Random user-agent strings and referrer URLs for web crawling.
...
def get_random_referrer():
    """Return a random referrer URL."""
    return random.choice(REFERRERS)


def get_random_headers():
    """Return a complete dict of randomized request headers."""
    headers = {
